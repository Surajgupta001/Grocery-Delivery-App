...
export function AppPromoBanner() {
    return (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 my-14 bg-green-950 rounded-2xl">
            <div className="flex flex-col md:flex-row items-center justify-baseline gap-8 xl:px-10">
                {/* Left Side */}
                <div className="text-center md:text-left">
                    ...
                    <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                        <button className="px-6 py-3 bg-white text-green-950 font-semibold rounded-xl hover:bg-orange-200">App Store</button>
