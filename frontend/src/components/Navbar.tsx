        ...
        <nav className="bg-white sticky top-0 z-50 border-b border-app-border">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 gap-4">
                ...
                <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
                    ...
                    {/* Search */}
                    <form className="hidden sm:flex flex-1 max-w-sm text-xs sm:text-sm" onSubmit={handleSearchSubmit}>
                    ...
                    <div className='flex items-center gap-3'>
                        ...
                        <button className="relative p-2 rounded-xl" onClick={() => setIsCartOpen(true)}>
                            ...
                            {cartCount > 0 && (
                                <span className="absolute -top-1 -right-1 size-4 bg-app-orange text-white text-[10px] rounded-full flex-center">{cartCount}</span>
                            )}
                        </button>
                        {/* user */}
                                        ...
                                        <div onClick={() => setUserMenuOpen(false)}>
                                            ...
                                            {user && (
                                                <div className="border-t border-app-border pt-1">
                                                    <button className="flex items-center gap-3 px-4 py-2.5 text-sm text-app-error hover:bg-red-50 w-full transition-colors" onClick={handleLogout}>
                                                        <LogOutIcon size={16} />
                                                        LogOut
                                                    </button>
                                                </div>
